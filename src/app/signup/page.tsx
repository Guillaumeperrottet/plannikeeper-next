// src/app/signup/page.tsx - Version corrigée
"use client";
...
const FormSkeleton = () => (
  <div className="w-full max-w-md animate-pulse">
    <div className="h-8 bg-[#e8ebe0] rounded-lg mb-6 mx-auto w-1/2"></div>
    <div className="h-24 w-24 bg-[#e8ebe0] rounded-full mx-auto mb-6"></div>
    <div className="space-y-4">
      <div className="h-4 bg-[#e8ebe0] rounded-lg w-1/3"></div>
      <div className="h-12 bg-[#e8ebe0] rounded-lg"></div>
      <div className="h-4 bg-[#e8ebe0] rounded-lg w-1/3"></div>
      <div className="h-12 bg-[#e8ebe0] rounded-lg"></div>
      <div className="h-4 bg-[#e8ebe0] rounded-lg w-1/3"></div>
      <div className="h-12 bg-[#e8ebe0] rounded-lg"></div>
      <div className="h-12 bg-[#e8ebe0] rounded-lg mt-4"></div>
    </div>
  </div>
);
...
const SignUpForm = dynamic(() => import("./signup-form"), {
  ...
  ssr: false, // Passer à false pour éviter les problèmes d'hydratation
});
...
export default function SignUpPage() {
  ...
  if (redirecting) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#f9f3ec] via-[#f5f3ef] to-[#e8ebe0]/50">
  ...
  // Afficher la page d'inscription normale si pas de code d'invitation
