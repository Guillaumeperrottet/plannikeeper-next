// src/app/signup/page.tsx - Redirection automatique si code d'invitation
"use client";
  ...
  if (inviteCode) {
    return (
      <div className="flex flex-col items-center justify-center h-full">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#d9840d]"></div>
        <p className="mt-4">Redirection vers la page d&apos;invitation...</p>
      </div>
    );
  }
  return null;
...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-svh bg-gradient-to-br from-[#f9f3ec] via-[#f5f3ef] to-[#e8ebe0]/50">
      {/* Redirection si un code d'invitation est présent */}
      {inviteCode ? (
